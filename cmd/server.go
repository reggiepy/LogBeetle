...
func init() {
	...
	serverCmd.Flags().String("log-file", "", "file to log")
	serverCmd.Flags().String("consumer-log-path", "", "Path to log")
	_ = viper.BindPFlag("log_file", serverCmd.Flags().Lookup("log-file"))
	_ = viper.BindPFlag("consumer_log_path", serverCmd.Flags().Lookup("consumer-log-path"))
}
